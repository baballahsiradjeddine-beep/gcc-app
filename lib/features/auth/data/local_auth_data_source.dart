...
class LocalAuthDataSource {
  ...
  void listenAccessToken(Function(dynamic) listener) {
    disposeAccessTokenListener = _secureStorage.listenKey(BoxKeys.token.name, listener);
  }

  void listenRefreshTokenKey(Function(dynamic) listener) {
    disposeRefreshTokenListener = _secureStorage.listenKey(BoxKeys.refreshToken.name, listener);
  }
  ...
  disposeListeners() {
   ...
   listenToTokens (Function(dynamic) accessTokenCallback, Function(dynamic) refreshTokenCallback) {
